...
public class SysRoleQueryService {
    ...
    public Mono<SysRoleView> getById(Long id) {
        return queryFactory.getR2dbcEntityTemplate().select(SysRoleEntity.class).matching(Query.query(
    ...
    public Mono<SysRoleView> getByCode(String code) {
        return queryFactory.getR2dbcEntityTemplate().select(SysRoleEntity.class).matching(Query.query(Criteria
