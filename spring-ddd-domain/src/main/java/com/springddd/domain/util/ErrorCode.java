...
public enum ErrorCode {
    ...
    ROLE_ID_NULL(1102, "error.role.id.null"),
    ROLE_STATUS_NULL(1103, "error.role.status.null"),

    MENU_NAME_NULL(1200, "error.menu.name.null"),
    MENU_TYPE_NULL(1201, "error.menu.type.null"),
    MENU_ICON_NULL(1202, "error.menu.icon.null"),
    MENU_PATH_NULL(1203, "error.menu.path.null"),
    MENU_ID_NULL(1204, "error.menu.id.null"),
    MENU_COMPONENT_NULL(1205, "error.menu.component.null"),
