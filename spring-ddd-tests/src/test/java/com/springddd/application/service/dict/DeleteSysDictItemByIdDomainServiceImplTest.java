...
import com.springddd.application.service.dict.DeleteSysDictItemByIdDomainServiceImpl;
...
class DeleteSysDictItemByIdDomainServiceImplTest {
    ...
    void setUp() {
        ...
        mockDomain.setItemBasicInfo(new DictItemBasicInfo("label", 1));
    ...
    void deleteByIds_shouldSetDeleteStatusToTrue() {
        ...
        verify(sysDictItemDomainRepository).save(argThat(domain -> domain.getDeleteStatus() == true));
    }
}
