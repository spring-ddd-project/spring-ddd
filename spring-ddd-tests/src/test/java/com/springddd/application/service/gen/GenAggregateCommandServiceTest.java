...
class GenAggregateCommandServiceTest {
    ...
    void create_shouldReturnId_whenValidCommand() {
        GenAggregateCommand command = createCommand();

        GenAggregateDomain mockDomain = new GenAggregateDomain();
        when(aggregateDomainFactory.newInstance(any(), any(), any()))
    ...
    void update_shouldComplete_whenValidCommand() {
        ...
        when(genAggregateDomainRepository.save(any())).thenReturn(Mono.empty());
    ...
    void delete_shouldComplete_whenValidIds() {
        ...
        GenAggregateDomain mockDomain = new GenAggregateDomain();
        when(genAggregateDomainRepository.load(any()))
                .thenReturn(Mono.just(mockDomain));
        when(genAggregateDomainRepository.save(any()))
