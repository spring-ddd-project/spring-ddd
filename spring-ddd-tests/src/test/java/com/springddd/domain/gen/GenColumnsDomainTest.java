...
class GenColumnsDomainTest {
    ...
    @Test
    void shouldThrowExceptionWhenUpdateWithNullForm() {
        GenColumnsDomain domain = new GenColumnsDomain();
        Prop prop = new Prop("key", "name", "type", "comment", "javaType", "entity");
        Table table = new Table(true, true, false, null, null);
        I18n i18n = new I18n("en", "locale");
        ...
        assertThrows(IllegalArgumentException.class, () -> {
            domain.update(prop, table, null, i18n, extendInfo);
        });
    }

    @Test
    void shouldThrowExceptionWhenUpdateWithNullI18n() {
        GenColumnsDomain domain = new GenColumnsDomain();
        Prop prop = new Prop("key", "name", "type", "comment", "javaType", "entity");
        Table table = new Table(true, true, false, null, null);
        Form form = new Form((byte) 1, true, false);
        ...
        assertThrows(IllegalArgumentException.class, () -> {
            domain.update(prop, table, form, null, extendInfo);
        });
    }

    @Test
    void shouldThrowExceptionWhenUpdateWithNullExtendInfo() {
        GenColumnsDomain domain = new GenColumnsDomain();
        Prop prop = new Prop("key", "name", "type", "comment", "javaType", "entity");
        Table table = new Table(true, true, false, null, null);
        Form form = new Form((byte) 1, true, false);
        ...
        assertThrows(IllegalArgumentException.class, () -> {
            domain.update(prop, table, form, i18n, null);
        });
    }
