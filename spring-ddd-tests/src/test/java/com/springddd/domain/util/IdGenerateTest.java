...
class IdGenerateTest {
    ...
    @Test
    void shouldHaveFieldAndTypeTarget() {
        ...
        assertEquals(ElementType.TYPE, target.value()[1]);
    }
    ...
    @Test
    void shouldTargetFieldsAndTypes() {
        Target target = IdGenerate.class.getAnnotation(Target.class);
        assertNotNull(target);
    ...
    @Test
    void shouldHaveDefaultStrategyIdTemp() throws NoSuchMethodException {
        assertEquals(IdGenerateStrategy.ID_TEMP, IdGenerate.class.getMethod("strategy").getDefaultValue());
    }

    @Test
    void shouldHaveDefaultEmptyKey() throws NoSuchMethodException {
        assertEquals("", IdGenerate.class.getMethod("key").getDefaultValue());
    }
}
